...
const PROJECTS = [
    {
        ...
        links: [
            { label: "GitHub", url: "https://github.com/yourusername/chatify" },
            { label: "Live Demo", url: "https://chatify.example.com" }
        ],
    },
    {
        ...
        links: [
            { label: "GitHub", url: "https://github.com/yourusername/portfolio-website" },
            { label: "Live Demo", url: "https://portfolio.example.com" }
        ],
    },
    {
        tag: "SQL * HTML",
        title: "Task Manager",
        desc: "A task management application that allows users to create, update, and delete tasks. Built with Node.js, Express, and SQL for the backend, and React for the frontend.",
        links: [
            { label: "GitHub", url: "https://github.com/yourusername/task-manager" },
            { label: "Live Demo", url: "https://taskmanager.example.com" }
        ],
    },
    {
    ...
    return (
        <section id="hero">
            ...
            <p className="hero-sub">
                I'm a passionate full-stack developer with experience in building dynamic and responsive web applications. I love turning ideas into reality using code and am always eager to learn new technologies and improve my skills.
            </p>
        ...
        <section id="about" className="divider">
            ...
            <div className="about-grid">
                <div>
                    ...
                    <p> When I am not coding, I enjoy exploring new technologies, contributing to open-source projects, and continuously improving my skills through learning and experimentation.</p>
                </div>
                <div>
                ...
                {PROJECTS.map((project) => (
                    <div className="card" key={project.title}>
                        ...
                        <div className="card-links">
                            {project.links.map((link) => <a key={link.label} href={link.url}>{link.label}</a>)}
                        </div>
                    </div>
                ))}
            </div>
...
function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!name || !email || !message) {
            setStatus({ type: "error", msg: "Please fill in all fields.", type: "error" });
            return;
        }
    ...
    return (
        <section id="contact" className="divider">
            ...
            <div className="contact-box">
                ...
                <div className="field">
                    <label>Message</label>
                    <textarea name="message" value={form.message} onChange={handleChange} placeholder="Your Message" rows="5"></textarea>
                </div>
